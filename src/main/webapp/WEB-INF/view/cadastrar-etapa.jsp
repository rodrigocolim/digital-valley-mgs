            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    <form method="POST" action="${selecao.codSelecao}" accept-charset="UTF-8" enctype="multipart/form-data" id="needs-validation" novalidate>
                        ...
                        <input type="text" name="titulo" value="${empty selecao.etapas ? 'Inscrição': ''}"  class="form-control" id="tituloInput" aria-describedby="tituloHelp" placeholder="Digite um título para a etapa" required>
