                ...
                <div class="form-group">
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/editarEtapa/${selecao.codSelecao}/inscricao/${etapa.codEtapa}" accept-charset="UTF-8"  id="needs-validation" novalidate>
                        ...
                        <div id="sandbox-container" class="input-group col-lg-6 align-left" style="padding-left: 0px;">
                        	...
                        	<c:if test="${!selecao.divulgada eq true}"><!-- Se nao -->
                        		<div class="input-daterange input-group col-lg-6 align-left" style="padding-left: 0px;" id="datepicker">
	                                <fmt:parseDate value="${etapa.periodo.inicio}" pattern="yyyy-MM-dd" var="parseDataInicio" type="date" />
	                                <fmt:formatDate value="${parseDataInicio}"  pattern="dd/MM/yyyy" var="dataInicio" type="date"/>
	                                <fmt:parseDate value="${etapa.periodo.termino}" pattern="yyyy-MM-dd" var="parseDataTermino" type="date" />
	                                <fmt:formatDate value="${parseDataTermino}"  pattern="dd/MM/yyyy" var="dataTermino" type="date"/>
	                                <input type="text" style="width:271.05px;height:38px" class="form-control text-left" placeholder="Digite a data de início desta etapa" id="periodoInput1" name="dataInicio" value="${dataInicio}" required/>
	                                <span class="input-group-addon">até</span>
	                                <input type="text" style="width:271.05px;height:38px" class="form-control text-left " placeholder="Digite a data de término desta etapa" id="periodoInput2" name="dataTermino" value="${dataTermino}" required/>
	                            </div>
                        	</c:if>
