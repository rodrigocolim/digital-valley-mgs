            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    <form method="POST" action="editarSelecao" accept-charset="UTF-8">
                        ...
                        <textarea class="form-control" name="descricao" id="descricaoInput" placeholder="Digite uma breve descrição sobre a seleção" value="${etapa.descricao}" required></textarea>
                        <div class="invalid-feedback">
                        ...
                        <textarea name="descricaoPreRequisitos" class="form-control" id="preRequisitosInput" placeholder="Digite uma breve descrição sobre os pré requisitos para participar da seleção" value="${selecao.descricaoPreRequisitos}">${selecao.descricaoPreRequisitos}</textarea>
                        <br>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="number" name="vagasRemuneradas" class="form-control col-sm-2 disabled" id="vagasRemuneradasInput" value="${selecao.vagasRemuneradas}" min="0" max="100" disabled>
                                <div class="invalid-feedback" >
                                ...
                                <input type="number" name="vagasVoluntarias" class="form-control col-sm-2 disabled" id="vagasVoluntariasInput" value="${selecao.vagasVoluntarias}" min="0" max="100" disabled>
                                <div class="invalid-feedback">
                        ...
                        <input type="file" name="edital" class="form-control" id="editalInput" aria-describedby="editalHelp" placeholder="Anexe o edital da seleção" value="${selecao.edital.titulo}" required>
                        <small id="tituloHelp" class="form-text text-muted">Tipo de arquivo .PDF</small>
                        <div class="invalid-feedback">
                            Envie um arquivo em formato .PDF
                        </div>
                        <br>
