        ...
        c = function() {
            ...
            return function(n, i, o) {
                ...
                function p() {
                    ...
                    "" === R() && (n[a.CREATELINK] = t.DISABLED, n[a.UNLINK] = t.DISABLED), e.each([a.CREATELINK, a.UNLINK, a.UNDO, a.REDO], function(e, r) {
                        l(r) || (n[r] = t.DISABLED)
                    });
                    for (var i = C(); null !== i;) {
                        if (i.tagName !== r) {
        ...
        cazary: function(e) {
            function s(t) {
                ...
                return e.each(t, function() {
                    var t = e("<ul />").addClass("cazary-commands-list btn"),
                        i = this.toLowerCase().split(" ");
                    e.each(i, function() {
                        var a = this.toString();
                        if ("|" === a && (a = "separator"), f[a] !== r) {
                            var i = n(f[a]), fad = n(font_awesome[a]),
                                o = "btn btn-default cazary-command-" + a,
                                c = e("<li />").attr({
                                    unselectable: "on",
                                    title: i
                                }).addClass(o).text(fad);
            ...
            var u = {
                ...
                d = '<div class="cazary form-control" style="width:100%"><iframe class="cazary-edit" src="javascript:" style="display:none;"></iframe></div>',
                f = {
                    separator: "",
                    fontname: "Font",
                    fontsize: "Size",
                ...
                function(f) {
                    return f = e.extend({
                        ...
                        function g(t, r, n) {
                            ...
                            return u.top += n.outerHeight(), i.addClass("cazary-panel form-control").addClass("cazary-panel-" + t).data("id", z).data("command", t).css({
                                left: u.left + "px",
                                top: u.top + "px"
                            }).on("click", function() {
                                return !1
                        ...
                        function O(r) {
                            ...
                            var c = e("<div>").append(e("<form />").attr("action", "#").append(e("<div />").append(e("<fieldset />").append(e("<legend />").text(n("Input image URL"))).append(e('<input type="text" />').addClass("cazary-widget-insertimage-url form-control").attr({
                                required: "required",
                                placeholder: n("http://example.com/path/to/image.jpg")
                            }))).append(e('<input type="submit" />').addClass("cazary-widget-submit btn btn-primary").val(n("Inserir")))).append(e("<fieldset />").addClass("cazary-widget-preview").append(e("<legend />").text(n("Preview"))).append(e("<img />").addClass("cazary-widget-preview-insertimage"))));
                        ...
                        function v(r) {
                            ...
                            var s = e("<div>").append(e("<form />").attr("action", "#").append(e("<div />").append(e("<fieldset />").append(e("<legend />").text(n("Input link URL or E-mail address"))).append(e('<input type="text" />').addClass("cazary-widget-createlink-url form-control").attr({
                                required: "required",
                                placeholder: n("http://example.com/, someone@example.com")
                            }))).append(e('<input type="button" />').addClass("cazary-widget-submit btn btn-primary").val(n("Inserir")))).append(e("<fieldset />").addClass("cazary-widget-preview").append(e("<legend />").text(n("Preview"))).append(e("<iframe />").addClass("cazary-widget-preview-createlink"))));
